...
public class ListaOrdenada {
  ...
  public void insertar() {
    ...
    this.contador++;
    int prioridadNuevoProceso = procesoNuevo.getPrioridad();
    ...
    while (procesoActual != procesoCajero) {
      ...
      int prioridadProcesoActual = procesoActual.getPrioridad();
  ...
  public void imprimirLista(){
    ...
    while (procesoAuxiliar.getSiguiente() != procesoCajero) {
      ...
      lista += " ("+procesoAuxiliar.getSiguiente().getNombreProceso() +","+procesoAuxiliar.getSiguiente().getPrioridad()+ ")";
      procesoAuxiliar = procesoAuxiliar.getSiguiente();
    }
